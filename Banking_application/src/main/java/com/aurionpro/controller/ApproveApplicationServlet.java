	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 HttpSession session = request.getSession(false);
	        ...
	        try {
	            ...
	            accService.approveApplication(appId, authUser.getUserId()); // calls stored proc
	            response.sendRedirect(request.getContextPath() + "/admin_dashboard?msg=Approved+application+" + appId);
