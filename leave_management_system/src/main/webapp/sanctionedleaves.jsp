...
<div class="card p-4">
        ...
        <c:if test="${empty sanctionedLeaves}">
				<div class="alert alert-info text-center">No sanctioned leaves available.</div>
			</c:if>
			<c:if test="${not empty sanctionedLeaves}">
        <table class="table table-hover table-striped align-middle">
            ...
            <tbody>
            <c:forEach var="leave" items="${sanctionedLeaves}">
                <tr>
