...
<div class="card p-4">
        ...
        <c:if test="${empty rejectedLeaves}">
				<div class="alert alert-info text-center">No rejected leave applications.</div>
			</c:if>
			<c:if test="${not empty rejectedLeaves}">
        <table class="table table-hover table-striped align-middle">
            ...
            <tbody>
            <c:forEach var="leave" items="${rejectedLeaves}">
                <tr>
